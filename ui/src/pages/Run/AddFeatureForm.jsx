...
import { addFeature } from "../../utils/client.js";

const AddFeatureForm = ({setOpen,open,setShowAlertCompletion, setAlertContent}) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            addFeature(id,{name, description})
                 .then((res) => {
                    setOpen(false)
                    setShowAlertCompletion(true)

                    const data = {
                        content: `Feature successfully added.`,
                        title: "Feature added"
                    }
                                                ...
                                                <div className="bg-primary px-4 py-6 sm:px-6">
                                                    ...
                                                    <div className="mt-1">
                                                        <p className="text-sm text-secondary">
                                                            Get started by filling in the information below to create your new feature.
                                                        </p>
                                                    </div>
                                                </div>
