...
import {addUser, fetchProjectById, updateProject} from "../../../utils/client.js";
...
const AddUserForm = ({setOpen,open,setShowAlertCompletion, setAlertContent}) => {
                                                ...
                                                <div className="bg-primary px-4 py-6 sm:px-6">
                                                    ...
                                                    <div className="mt-1">
                                                        <p className="text-sm text-secondary">
                                                            Search and add an user to this project.
                                                        </p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div className="space-y-6 pb-5 pt-6">
                                                            <div>
                                                                ...
                                                                {formik.touched.userId && formik.errors.userId ? (
                                                                    <div className="text-error">{formik.errors.userId}</div>
                                                                ) : null}
                                                            </div>
                                                        </div>
                                                    </div>
