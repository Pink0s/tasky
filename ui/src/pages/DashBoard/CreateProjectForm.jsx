...
import {createProject} from "../../utils/client.js";
import ErrorNotification from "../../components/ErrorNotification.jsx";

export default function CreateProjectForm({setOpen,open,setShowAlertCompletion, setAlertContent}) {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            createProject({name, date, description})
                .then((res) => {
                    setOpen(false)
