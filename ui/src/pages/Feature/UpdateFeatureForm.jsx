...
import { fetchFeatureById , updateFeature} from "../../utils/client.js";

const UpdateFeatureForm = ({setOpen,open,setShowAlertCompletion, setAlertContent}) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            let {name, description, status} = values;
            const id = params.id

            updateFeature(Number(id),{name, description, status})
                 .then((res) => {
                    setOpen(false)
                    setShowAlertCompletion(true)

                    const data = {
                        content: `Feature successfully updated.`,
                                            ...
                                            <div className="h-0 flex-1 overflow-y-auto">
                                                <div className="bg-primary px-4 py-6 sm:px-6">
                                                    ...
                                                    <div className="mt-1">
                                                        ...
                                                        Begin by modifying the information below to update the feature. In edit mode, you can modify feature name, the status and the description.
                                                        </p>
                                                    </div>
                                                </div>
